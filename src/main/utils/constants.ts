...
const ERROR_COMMON_CONFIG = 4
const ERROR_SPECIFIC_CONFIG = 5

export { ERROR_ALREADY_EXIST, ERROR_COMMON_CONFIG, ERROR_PARSING_TEMPLATE, ERROR_RETRIEVING_INFO, ERROR_SPECIFIC_CONFIG, NO_ERROR }
